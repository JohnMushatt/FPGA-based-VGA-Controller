...
HD_PWD='C:/Users/jemushatt/Desktop/vga/vga.runs/clk_147MHz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_147MHz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_147MHz.tcl
